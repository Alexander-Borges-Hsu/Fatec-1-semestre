...
def calcinvestimento():
    if tipo_poupanca == 1:
        ...
        stringInveste = "poupança"  
    elif tipo_poupanca == 2:
        previsao = valor_investimento * (1 + 0.05) ** mes_investimento
        stringInveste = "renda fixa"

    if tipo_poupanca == 1 or tipo_poupanca == 2:
        print(f"Os seus R${valor_investimento} irão se transformar em R${previsao:.2f} em {mes_investimento} meses com a {stringInveste}.")
    else:
